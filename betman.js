...
(async () => {
    ...
    // 지정된 URL 접속
    await page.goto('https://www.betman.co.kr/main/mainPage/customercenter/agreement.do');
    await page.waitForSelector('#agreementCtt > div > div.polCtn');
    const data = {};
    const temp = await page.$('#agreementCtt > div > div.polCtn');
